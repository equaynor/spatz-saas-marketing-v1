            ...
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="relative">
                  <input type="text" id="firstName" className="peer w-full bg-transparent border-b border-white/20 py-3 text-white focus:outline-none focus:border-white transition-colors placeholder-transparent" placeholder="First / Last Name*" required />
                  <label htmlFor="firstName" className="absolute left-0 top-3 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-3 peer-focus:-top-4 peer-focus:text-xs peer-focus:text-white uppercase tracking-wider">First / Last Name*</label>
                </div>
                <div className="relative">
              ...
              <div className="relative">
                <input type="tel" id="phone" className="peer w-full bg-transparent border-b border-white/20 py-3 text-white focus:outline-none focus:border-white transition-colors placeholder-transparent" placeholder="Phone*" required />
                <label htmlFor="phone" className="absolute left-0 top-3 text-gray-500 text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-3 peer-focus:-top-4 peer-focus:text-xs peer-focus:text-white uppercase tracking-wider">Phone*</label>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <label htmlFor="consent" className="text-sm text-gray-500 font-light">
                  I consent to the processing of my personal data to respond to my request. SPATZ commits to not using your information for other purposes.
                </label>
              </div>
